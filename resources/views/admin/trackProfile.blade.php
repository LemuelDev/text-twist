                ...
                <!-- Your main content goes here -->
                        ...
                        <div class="grid gap-6 shadow-xl rounded-xl pt-8">
                            ...
                            <div class="rounded-xl p-8">
                                 <h1 class="lg:text-3xl text-2xl font-bold ">Edit Profile 👤</h1>
                                 <form action="{{route('admin.updateProfile')}}" method="POST" class="grid grid-cols-1 max-w-xl gap-6 pt-5 ">
                                    @csrf
                                        ...
                                        <div class="flex gap-4 justify-start items-center">
                                            ...
                                            <input type="text" name="email" value="{{auth()->user()->userProfile->email}}" class="  bg-transparent rounded-lg shadow lg:px-10 px-4 py-3 text-left text-md w-full">
                                        </div>
                                        <button class="px-10 py-3 rounded-md text-center border-none text-lg text-white shadow bg-green-600 hover:bg-green-700 max-w-[400px] mx-auto">UPDATE</button>
                                 </form>
                            </div>
