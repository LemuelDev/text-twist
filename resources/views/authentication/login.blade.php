...
<body>
    ...
    <div class="intro-wrap">
        ...
        {{-- content --}}
       <div class="pt-40">
          <form action="{{route("user.login")}}" method="POST" class="flex justify-center items-center flex-col gap-4 rounded-md outline-none  max-w-[400px] mx-auto shadow-xl p-8 px-8">
              @csrf
